...
<br>
User administrator runs an application which takes input without sanitization from an Ethereum smart contract. Such smart contract seems not subject to access control based on signing, and contains a function that can set the input value, and the visibility of this function is public. The RPC endpoint of this Ethereum network is available for everyone.<br>
<!-- excerpt-end -->
<br>
<br>
<br>
